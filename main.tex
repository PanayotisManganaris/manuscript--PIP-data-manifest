...
relatively recently demonstrated extraordinary \acrfull{pce} between 20$\backslash$% and 25$\backslash$% when used as absorbers in
...
of theory used are discussed in \hyperref[sec:org836fa98]{Methodology}. The relatively large
...
parameters. However, per the \hyperref[sec:orgf80ac57]{Deviation from Cubicity} metric, this
...
section \hyperref[sec:orge6bbcdd]{Comparing synthetic to physical data}

Also, we will explore methods for combining the insights of the \acrshort{pbe}
and \acrshort{hse} datasets in training surrogates, e.g. in section \hyperref[sec:org5c5f2b2]{SLME calculations} the two \gls{slme} spectra could be used together to converge
...
\label{sec:orge1b2c07}
\ldots{}\\

\section*{Conflicts of Interest}
\label{sec:org3e108e8}
There are no conflicts to declare.

\section*{Acknowledgements}
\label{sec:org3eb148b}
