...
\newglossaryentry{slme}{name=SLME, description={Spectroscopically Limited Maximum Efficiency}, user1=\citeauthor{yu-2012-ident-poten}}
...
from VASP. This calculation is performed separately for the \acr{pbe}
band gaps and the \acr{hse} band gaps, resulting in two synthetic
efficiencies for each record.

\section*{{\bfseries\sffamily TODO} Results and discussion}
\label{sec:org2a78554}
\subsection*{{\bfseries\sffamily TODO} Visualization of DFT Data}
\label{sec:orgaeaf0e0}
\begin{figure*}
\centering
...
\label{sec:org14f7d2d}
\ldots{}\\

\section*{Perspective and Future Work}
\label{sec:org9239cd6}
...
\section*{Conclusions}
\label{sec:org1f6906b}
\ldots{}\\

\section*{Conflicts of interest}
\label{sec:org0514288}
There are no conflicts to declare.

\section*{acknowledgements}
\label{sec:org7d123a9}
