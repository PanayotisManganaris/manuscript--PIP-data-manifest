...
\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./figs/cub_b_decomp.png}
\caption{\label{fig:cub_b} PBE Deviation from Cubicity plot at b axis}
\end{figure*}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./figs/cub_c_decomp.png}
...
\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./figs/cub_beta_decomp.png}
\caption{\label{fig:cub_beta} PBE Deviation from Cubicity plot at beta}
\end{figure*}

\begin{figure*}
\centering
\includegraphics[width=.9\linewidth]{./figs/cub_gamma_decomp.png}
