...
\section*{Methodology}
\label{sec:org3a23ca2}
\subsection*{Building Perovskite Dataset}
\label{sec:orge489ad4}
...
\label{sec:org620ccde}

\subsubsection*{SLME Package}
\label{sec:org9619917}
...
\label{sec:orgdf11108}
\subsection*{Visualization of DFT Data}
\label{sec:orgf698693}
\begin{figure*}
\centering
...
\caption{\label{fig:lc_lot_vs} Comparing lattice constants obtain by full PBE and HSE relax calculations}
\end{t}

\subsubsection*{Comparing synthetic to physical data}
\label{sec:org6b71d90}

\begin{t}
\centering
\includegraphics[width=.9\linewidth]{pbe_v_exp_LC.png}
\caption{\label{fig:lc_val_vs} Comparison of PBE and HSE computed pseudo-cubic lattice constants with crystallographic measures for lattice constants}
\end{t}
\begin{t}
\centering
...
\label{sec:org5f0be7c}

\section*{Perspective and Future Work}
\label{sec:org96850dd}
...
\section*{Conclusions}
\label{sec:org5da0222}
\ldots{}\\

\section*{Conflicts of interest}
\label{sec:orgd9ed65e}
There are no conflicts to declare.

\section*{acknowledgements}
\label{sec:orgca7a6c4}
