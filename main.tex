...
\section*{Methodology}
\label{sec:org12a2078}
\subsection*{Building Perovskite Dataset}
\label{sec:org93080c2}
...
\label{sec:orgc19fafa}

\subsubsection*{SLME Package}
\label{sec:org2825665}
...
\label{sec:orgec3a7b7}
\subsection*{Visualization of DFT Data}
\label{sec:orgca41615}
\begin{figure*}
\centering
...
\label{sec:orge5941cf}

\section*{Perspective and Future Work}
\label{sec:org2630ce0}
...
\section*{Conclusions}
\label{sec:org1ed612c}
\ldots{}\\

\section*{Conflicts of interest}
\label{sec:org1821c83}
There are no conflicts to declare.

\section*{acknowledgements}
\label{sec:orgb8d3537}
