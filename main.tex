...
3 angles, α, β and γ, to make sure the angle also remain 90
degrees. We calculated the difference of α, β and γ versus 90 degrees,
...
them.  Fig 7 (d) shows the screening results for α angle deviation of
cubicity. SI Fig X shows the screening results for b, c lattice and β,
γ angle. Most of the samples with non-cubic perovskites structures are
