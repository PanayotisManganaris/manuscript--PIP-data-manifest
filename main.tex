...
\caption{\label{Fig:pairplots} Visualization of DFT data: PBE and HSE properties; lattice constants, decomposition energies, band gaps, photovoltaic figure of merit.}
\end{figure*}
...
\section*{Methodology}
\label{sec:org820a64c}
\subsection*{Building Perovskite Dataset}
\label{sec:org9138815}
...
here the tense must be consistent.

\subsection*{Calculation Details}
\label{sec:orge1cb780}
...
\label{sec:orgc8c510e}
\subsection*{Analysis of DFT Computed Properties}
\label{sec:org596440e}
\subsubsection*{Decomposition Energy}
\label{sec:org51b0e9e}
The decomposition energy is an important property showing the stability
of perovskite. To calculate the decomposition energy for ABX3
perovskite, we assume it will decompose to two phases, AX and BX2. Using
DFT calculations, we can get the optimized energy of perovskite and its
decomposed compounds.

The equation is presenting the details calculation for decomposition
energy. For PBE decomposition energy, we use DFT energy results from PBE
level calculation. For HSE decomposition energy, we use the energy from
HSE level calculations.

\subsubsection*{Band Gap and Band Structure}
\label{sec:org37c15e7}
\subsubsection*{SLME Package}
\label{sec:org5217761}
\section*{Results and discussion}
\label{sec:orgf4e0cec}
\subsection*{Visualization of DFT Data}
\label{sec:orgdeffe46}
shows plots for critical properties of perovskites in the datasets.

\subsubsection*{Lattice constant PBE vs HSE}
\label{sec:orgf1baed9}
...
\label{sec:orgffd61a8}

\section*{Perspective and Future Work}
\label{sec:org439aa30}
...
\section*{Conclusions}
\label{sec:orgce19aa4}
\ldots{}\\

\section*{Conflicts of interest}
\label{sec:org7f70a6a}
There are no conflicts to declare.

\section*{Acknowledgements}
\label{sec:org146fcf9}
